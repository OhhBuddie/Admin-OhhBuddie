        ...
        <form action="{{ route('footers.update',$footer->id) }}" method="POST">
            ...
            <div class="mb-3">
                <label for="category" class="form-label">Category</label>
                 ...
                 <select name="category" id="page" class="form-control">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="subcategory" id="subcategory" value="{{$footer->subcategory}}" class="form-control">
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="footer" id="footer" class="form-control" rows="6" value="{{$footer->footer}}" required>{{$footer->footer}}</textarea>
            </div>
