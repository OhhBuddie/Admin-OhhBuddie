            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-4">
                  <a href="/allorders" class="btn btn-info btn-sm" style="background-color:#efc475; font-size:11px; color: black; border-color:#efc475">See All Orders</a>
                </li>
                <li class="nav-item lh-1 me-4">
                  <a href="/catproduct" class="btn btn-info btn-sm" style="background-color:#efc475; font-size:11px; color: black; border-color:#efc475">Category Wise Product</a>
                </li>
                <li class="nav-item lh-1 me-4">
                  <a href="/product/allseller" class="btn btn-info btn-sm" style="background-color:#efc475; font-size:11px; color: black; border-color:#efc475">See All Seller</a>
                </li>
                <li class="nav-item lh-1 me-4">
                  <a href="/alluser" class="btn btn-info btn-sm" style="background-color:#efc475; font-size:11px; color: black; border-color:#efc475">See All Customer</a>
                </li>
                <li class="nav-item lh-1 me-4">
                  <a href="/product/sellerproduct" class="btn btn-info btn-sm" style="background-color:#efc475; font-size:11px; color: black; border-color:#efc475">See All Product</a>
                </li>
                
                <li class="nav-item lh-1 me-4">
                  <a href="/allrefunds" class="btn btn-info btn-sm" style="background-color:#efc475; font-size:11px; color: black; border-color:#efc475">Refund requests</a>
                </li>
                <li class="nav-item lh-1 me-4">
                  <a href="/seller/registration" class="btn btn-info btn-sm" style="background-color:#efc475; font-size:11px; color: black; border-color:#efc475">Add Seller</a>
                </li>
                <li class="nav-item lh-1 me-4">
                  <a href="/seller/registration" class="btn btn-info btn-sm" style="background-color:#efc475; font-size:11px; color: black; border-color:#efc475">Footers</a>
                </li>
