...
<body>
            ...
            <form action="{{ route('product.update2',$product->id ) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <label class="form-label">Brand</label>
                                ...
                                @else
                                    @php
                                        $brands = \App\Models\Brand::where('seller_id', $product->seller_id)->get();
                                    @endphp
               ...
               <!--For Sarees -->
                ...
                <div class="card Jeans" style="display:none;">
                    ...
                    <div class="row g-3">            
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2" name="distressed_non_distressed" value="{{$product->distressed_non_distressed}}">
                                <option selected value="{{$product->distressed_non_distressed}}">{{$product->distressed_non_distressed}}</option>
                    ...
                    <div class="row g-3">          
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2" name="upper_material">
                                <option selected value="{{$product->upper_material}}">{{$product->upper_material}}</option>
                                <option>Leather</option>
                ...
                <div id="card_container">
                    @foreach($multidata as $key => $mult)
                        <div class="card cards mt-3 position-relative">
                            ...
                            @if (!$loop->first)
                                ...
                                <button type="button" class="btn btn-danger btn-sm"
                                    style="position: absolute; top: 10px; right: 10px; z-index: 10; background-color:red"
                                    ...
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            <div class="row g-3">
                                                    ...
                                                    <select class="form-control select2 size_select" name="size{{$mult['id']}}" style="width:100%">
                                                        ...
                                                        @foreach($size as $sz)
                                                            @if(is_array($sz->details) || is_object($sz->details))
                                                                ...
                                                                @endforeach
                                                            @else
                                                                @php $details = json_decode($sz->details); @endphp
                                                ...
                                                {{-- Measurement Logic --}}
                                                @if($subcat_id == 2 || $subcat_id == 46 || $subcat_id == 12)
                                                    @php $hipOptions = range(10, 70); $weistOptions = range(10, 70); $productLengthOptions = range(10, 70); @endphp
                                                @elseif($subcat_id == 17 || $subcat_id == 59 && $subsubcat_id != 40 && $subsubcat_id != 44 && $subsubcat_id != 45)
                                                    @php $hipOptions = range(30, 54); $weistOptions = range(24, 50); $productLengthOptions = range(26, 60); @endphp
                                                @else
                                                    @php $hipOptions = []; $weistOptions = []; $productLengthOptions = []; @endphp
                                                @endif
                    
                                                {{-- Bust --}}
                                                <div class="col-md-4">
                                                    <label class="form-label">Bust Size</label>
                                                    <select name="bust_size" class="form-control quantity_input" onchange="updateHiddenInput()">
                                                        <option value="{{ $mult['bust_size'] }}" selected>{{ $mult['bust_size'] }}</option>
                                                        @for ($i = 10; $i <= 70; $i++)
                                                ...
                                                {{-- Hip --}}
                                                <div class="col-md-4">
                                                    <label class="form-label">Hip Size</label>
                                                    <select name="hip_size" class="form-control quantity_input" onchange="updateHiddenInput()">
                                                        <option value="{{ $mult['hip_size'] }}" selected>{{ $mult['hip_size'] }}</option>
                                                        @foreach($hipOptions as $i)
                                                            <option value="{{ $i }}">{{ $i }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                {{-- Weist --}}
                                                <div class="col-md-4">
                                                    <label class="form-label">Weist Size</label>
                                                    <select name="weist_size" class="form-control quantity_input" onchange="updateHiddenInput()">
                                                        <option value="{{ $mult['weist_size'] }}" selected>{{ $mult['weist_size'] }}</option>
                                                        @foreach($weistOptions as $i)
                                                            <option value="{{ $i }}">{{ $i }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                {{-- Shoulder --}}
                                                <div class="col-md-4">
                                                    <label class="form-label">Shoulder Size</label>
                                                    <select name="shoulder_size" class="form-control quantity_input" onchange="updateHiddenInput()">
                                                        <option value="{{ $mult['shoulder_size'] }}" selected>{{ $mult['shoulder_size'] }}</option>
                                                        @for ($i = 10; $i <= 70; $i++)
                                                            <option value="{{ $i }}">{{ $i }}</option>
                                                        @endfor
                                                    </select>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="product_length" class="form-control quantity_input" onchange="updateHiddenInput()">
                                                        <option value="{{ $mult['product_length'] }}" selected>{{ $mult['product_length'] }}</option>
                                                        @foreach($productLengthOptions as $i)
                                                            <option value="{{ $i }}">{{ $i }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" class="form-control" name="sku{{$mult['id']}}" placeholder="Enter SKU Code" value="{{$mult['sku']}}" readonly>
                                                </div>
                    
                                                {{-- MRP --}}
                                                <div class="col-md-4">
                                                    <label class="form-label">Maximum Retail Price</label>
                                                    <input type="number" class="form-control" name="maximum_retail_price{{$mult['id']}}" placeholder="Enter Maximum Retail Price" value="{{$mult['mrp']}}" readonly>
                                                </div>
                    
                                                {{-- BSP --}}
                                                <div class="col-md-4">
                                                    <label class="form-label">Bank Settlement Price</label>
                                                    <input type="number" class="form-control" name="bank_settlement_price{{$mult['id']}}" placeholder="Enter Bank Settlement Price" value="{{$mult['bsp']}}" readonly>
                                                </div>
                                                ...
                                                <input type="hidden" class="form-control" name="ids{{$mult['id']}}" placeholder="Enter SKU Code" value="{{$mult['id']}}" oninput="updateHiddenInput()">
                ...
                <div class="card">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label">Product Status {{$product->pstatus}}</label>
                          <label class="switch">
                            <input 
                                type="checkbox" 
                                class="toggle-status" 
                                data-id="{{ $product->id }}" 
                                name="pstatus"
                                {{ $product->pstatus ? 'checked' : '' }}>
                            <span class="slider round">
                                <span class="slider-label on" style="text-align:left">Active</span>
                                <span class="slider-label off" style="text-align:right">In-Active</span>
                            </span>
                        </label>                        
                        </div>
    ...
    function updateHiddenInput() {
        ...
        allCards.forEach(card => {
            let id = card.querySelector('input[name^="ids"]')?.value || '';
            let size = card.querySelector('.size_select')?.value || '';
            let quantity = card.querySelector('.quantity_input[name^="quantity"]')?.value || '';
            ...
            // Measurement fields
            let bust = card.querySelector('[name^="bust_size"]')?.value || '';
            let hip = card.querySelector('[name^="hip_size"]')?.value || '';
            let weist = card.querySelector('[name^="weist_size"]')?.value || '';
            let shoulder = card.querySelector('[name^="shoulder_size"]')?.value || '';
            let productLength = card.querySelector('[name^="product_length"]')?.value || '';
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-1">
                        <div class="action_container">
                            <button type="button" class="btns danger" onclick="remove_card(this)">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Bust Size</label>
                                <select name="bust_size" class="form-control quantity_input" onchange="updateHiddenInput()">
                                    <option value="" selected disabled>--Select Bust Size--</option>
                                      @for ($i = 10; $i <= 70; $i++)
                                            <option value="{{ $i }}">{{ $i }}</option>
                                      @endfor                                           
                                </select>
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Hip Size</label>
                                <select name="hip_size" class="form-control quantity_input" onchange="updateHiddenInput()">
                                    <option value="" selected disabled>--Select Hip Size--</option>
                                      if(subcat_id == 17 || subcat_id == 59 && $subsubcat_id != 40 && $subsubcat_id != 44 && $subsubcat_id != 45)
                                      {
                                          @for ($i = 30; $i <= 54; $i++)
                                                <option value="{{ $i }}">{{ $i }}</option>
                                          @endfor 
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Weist Size</label>
                                <select name="weist_size" class="form-control quantity_input" onchange="updateHiddenInput()">
                                    <option value="" selected disabled>--Select Weist Size--</option>
                                      if(subcat_id == 17 || subcat_id == 59 && $subsubcat_id != 40 && $subsubcat_id != 44 && $subsubcat_id != 45)
                                      {
                                          @for ($i = 24; $i <= 50; $i++)
                                                <option value="{{ $i }}">{{ $i }}</option>
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Shoulder Size</label>
                                <select name="shoulder_size" class="form-control quantity_input" onchange="updateHiddenInput()">
                                    <option value="" selected disabled>--Select Shoulder Size--</option>
                                      @for ($i = 10; $i <= 70; $i++)
                                            <option value="{{ $i }}">{{ $i }}</option>
                                      @endfor                                           
                                </select>
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Product Length</label>
                                <select name="product_length" class="form-control quantity_input" onchange="updateHiddenInput()">
                                    <option value="" selected disabled>--Select Product Length--</option>
                                      if(subcat_id == 17 || subcat_id == 59 && $subsubcat_id != 40 && $subsubcat_id != 44 && $subsubcat_id != 45)
                                      {
                                          @for ($i = 26; $i <= 60; $i++)
                                                <option value="{{ $i }}">{{ $i }}</option>
