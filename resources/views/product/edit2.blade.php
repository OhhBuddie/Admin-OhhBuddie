                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" class="form-control" name="maximum_retail_price{{$mult['id']}}" placeholder="Enter Maximum Retail Price" value="{{$mult['mrp']}}" realonly>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Bank Settlement Price</label>
                                            <input type="number" class="form-control" name="bank_settlement_price{{$mult['id']}}" placeholder="Enter Bank Settlement Price" value="{{$mult['bsp']}}" realonly>
                                        </div>
                                        <div class="col-md-4">
