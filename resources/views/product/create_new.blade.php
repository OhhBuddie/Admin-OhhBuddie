...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="left-column">
            <form action="{{ route('products.store_new' ) }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <!--New Fields Related To Size Start-->
                                        @if($subcat_id == 2 || $subcat_id == 46 || $subcat_id == 12)                                  
                                            <div class="col-md-4">
                                                <label class="form-label">Bust Size</label>
                                                <!--<input type="text" class="form-control quantity_input" name="bust_size" placeholder="Enter Quantity" oninput="updateHiddenInput()"  placeholder="Enter Quantity">-->
                                        ...
                                        @endif
                                        <!--New Fields Related To Size End-->
...
<script>
    function updateHiddenInput() {
        ...
        cards.forEach((card) => {
            ...
            let bustInput = card.querySelector("[name='bust_size']");
            let hipInput = card.querySelector("[name='hip_size']");
            let weistInput = card.querySelector("[name='weist_size']");
            let shoulderInput = card.querySelector("[name='shoulder_size']");
            let productLengthInput = card.querySelector("[name='product_length']");


            if (
                sizeSelect && quantityInput &&
                sizeSelect.value && quantityInput.value &&
                sizeSelect.value !== "--Select Size--" && sizeSelect.value !== "disabled"
            ) {
                data.push({
                    ...
                    bust_size: bustInput ? bustInput.value : null,
                    hip_size: hipInput ? hipInput.value : null,
                    weist_size: weistInput ? weistInput.value : null,
                    shoulder_size: shoulderInput ? shoulderInput.value : null,
                    product_length: productLengthInput ? productLengthInput.value : null,
                });
            }
        });
    ...
    function create_card() {
        ...
        let subsubcat_id = @json($subsubcat_id);
        newCard.innerHTML = `
            <div class="card-title">
                <div class="row g-3">
                    <div class="col-md-2">Inventory Details</div>
    ...
    function remove_card(button) {
        let card = button.closest(".card");
        card.remove();
        updateHiddenInput(); // Update data after removing a card
    }
</script>
    <script>
