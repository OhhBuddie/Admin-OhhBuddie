...
<style>
    ...
    <style>
        ...
        /* Adjust the top offset for sticky header */
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        ...
        <a href="javascript:history.back();" style="font-size: 17px; margin-right: 11px; color: black;">
           <i class="fa-solid fa-arrow-left"></i>
            ...
            <a class="navbar-brand fw-bold" href="#">All Seller</a>
    ...
    <div class="container-fluid py-4">
        ...
        <table id="sellerProductsTable" class="table table-hover table-bordered table-striped table-dark">
            <thead>
                <tr>
                    <th style="background-color:#EFC475; color:black; text-align:center">SL.</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Company Name</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Email</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Total Brands</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Total Product</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Total Active Product</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Total Inactive Product</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Total Orders</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Total Order Value</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">State</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">City</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Shipping Mode</th>
                    <th style="background-color:#EFC475; color:black; text-align:center">Action</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group gap-2">
                            <a href="{{ route('seller.profileedit', $sellers->id) }}">
...
<!--<script src="https://cdn.datatables.net/1.13.6/js/dataTables.bootstrap5.min.js"></script>-->
    ...
    <script>
        $(document).ready(function () {
            var table = $('#sellerProductsTable').DataTable({
                pageLength: 10,
                ordering: true,
                searching: true,
